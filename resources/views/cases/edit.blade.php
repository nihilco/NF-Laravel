          ...
          <div class="row">
	        <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control{{ $errors->first('doi') ? ' is-invalid' : '' }}" id="doi" name="doi" aria-describedby="doiHelp" value="{{ $clientCase->incident_at->format('m/d/Y') }}" data-provide="datepicker" data-date-format="mm/dd/yyyy">
	                @if($errors->first('doi'))
		      ...
		      <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control{{ $errors->first('dos') ? ' is-invalid' : '' }}" id="dos" name="dos" aria-describedby="dosHelp" value="{{ $clientCase->settled_at->format('m/d/Y') }}" data-provide="datepicker" data-date-format="mm/dd/yyyy">
	                @if($errors->first('dos'))
